...
<html lang="en">
    ...
    <body>
        ...
        <%
            ...
            try {
                ...
                ResultSet rs = stat.executeQuery("SELECT * FROM WITHOUT_PRESC WHERE ORDER_ID="+OID);
                if(rs.next()){
        %>
        ...
        <table style="width:100%">
            ...
            <tr align="center">
                <th colspan="3" style="font-size:3vw;">MY ORDER DETAILS</th>
            </tr>
            <tr>
                <td colspan="3"></td>
            </tr>
            <tr>
                ...
                <td  style="background-color: #E6E6FA"> 
                        <table style="width:100%">
                            ...
                            <tr>
                                <td colspan="2" style=" text-align: center"><h2>MEDICINE ORDERED</h2></td>
                            </tr>
                            <tr>
                            ...
                            <tr align=center>	
                                <td colspan="2" >
                                   <button type="submit" style="  border: none; border-radius: 50px ;width: 250px; 
                                            background-color: #0c8195; padding: 12px 28px; color: #ffffff">Order</button>
                                            <button type="button" style="border-radius: 50px ;border: none ;width: 250px;
                                                    background-color: #0c8195; padding: 12px 28px;color: #ffffff" ><a style="color: #ffffff" href="welcome.jsp"> Cancle</a></button></td>
                            </tr>
                        </table>
                </td>
                <td></td>
    ...
    <center> <h2>   NO MEDICINE ADDED TO ORDER LIST<br>
            Click<a href="med_list.jsp?shop_no=<%=shop_no%>&address=<%=address%>"> here</a> to add medicine to list.
        </h2></center>
        <%        }
            }
            catch(Exception e){
