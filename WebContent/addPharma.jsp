...
<body>
	...
	<div class="container emp-profile">
        <div class="container">
        	<center><h1 style="margin-bottom:10px;">REGISTER PHARMACIST</h1></center>
            <div class="signup-content">
            	<form method="POST" action="succInPharma.jsp" class="register-form" id="register-form">
                	<div class="form-row">
                    	<div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <div class="form-input">
                                    <label for="shopNo" class="required">Shop Number</label>
                                    <input type="text" name="shopNo" id="shopNo" />
                                </div>
                            </div>
                            <div class="form-submit" style="margin-top:30%">
	...
	<footer class="site-footer">
     ...
     <script src="jsAdminLogin/Pharmajs.js"></script>
