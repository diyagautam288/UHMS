...
<body>
	...
	<div class="container emp-profile">
        <div class="container">
        	<center><h1 style="margin-bottom:10px;">REGISTER DOCTOR</h1></center>
            <div class="signup-content">
            	<form method="POST" action="succInDoc.jsp" class="register-form" id="register-form">
                	<div class="form-row">
                    	<div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <div class="form-input">
                                    <label for="dept_id" class="required">Department ID</label>
	...
	<footer class="site-footer">
     ...
     <script src="jsAdminLogin/regForm.js"></script>
