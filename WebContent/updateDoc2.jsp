...
<html>
    ...
    <div class="container emp-profile">
        <center><h2 style="margin-bottom:20px;">UPDATE DOCTOR</h2></center>
        <div>
            <%
            ...
            <%
                try {
                    ...
                    String sql = "select DOCTOR.EMAIL,DOCTOR.DOC_ID,REG_USER.PHONE_NO,REG_USER.SECRET,DOCTOR.FEES from DOCTOR INNER JOIN REG_USER ON DOCTOR.EMAIL=REG_USER.EMAIL and DOCTOR.DOC_ID= " + id;
                    resultSet = st.executeQuery(sql);
                    while (resultSet.next()) {
            %>
            <form method="post" action="update-process.jsp">
                <div class="row">
                    <h3 class="col-md-6" >ID: <input readonly name="doc_id" value="<%=resultSet.getString("DOC_ID")%>"></h3>
                    <h3 class="col-md-6" >EMAIL: <input readonly name="email" value="<%=resultSet.getString("EMAIL")%>"></h3>
                </div>
                <br>
                <div class="row">
                    <div class="col-md-6">
                        <div class="row">
                            ...
                            <div class="col-md-4" style="margin-bottom:20px;">
                                <input class="Input" type="text" name="fees" value="<%=resultSet.getString("FEES")%>">
                            </div>
                        </div>
                    </div>
                    <div class="col-md-6">
