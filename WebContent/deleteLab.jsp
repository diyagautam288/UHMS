...
<body>
	...
	<div class="container emp-profile" style="height:50%;">
            <center><h2 style="margin-bottom:20px;">DELETE LAB SPECIALIST</h2></center>
            <form method="POST" action="succDelLab.jsp">
			  	<center>
			  	<div style="width:30%;margin-bottom:3%;margin-top:2%;">
			  		<center>
