...
<body>
	...
	<div class="container emp-profile" style="height:50%;">
            <center><h2 style="margin-bottom:20px;">UPDATE LAB SPECIALIST</h2></center>
            <form method="GET" action="updateLab2.jsp">
			  	<center>
			  	<div style="width:20%;margin-bottom:3%;margin-top:2%;">
					...
					<center>
					<center><input class="empMbutton" type="submit" value="UPDATE"></center>
				</div>
			  </center>
			  </form>
