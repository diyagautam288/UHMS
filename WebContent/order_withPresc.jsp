...
<html>
    ...
    <body>
        ...
        <% User user = (User) session.getAttribute("logUser");
            ...
            try {
                ...
                stat2.executeUpdate("DELETE FROM WITH_PRESC WHERE ORDER_ID NOT IN(SELECT ORDER_ID FROM MED_ORDER)");

                Statement stat = con.createStatement();
                rs = stat.executeQuery("SELECT * FROM PRESCRIPTION WHERE PID="+ID+" ORDER BY DATE DESC");

                if (!rs.next()) {
        %>
    <center> 
        <h3>    <strong>No prescription found.</strong></h3><br/>
        Click<a href="welcome.jsp"> here</a> to go back.
    </center>
    <br/><br/><br/>
    ...
    <form style="background-color: #ffffff" method="post" action="#">
        <center><h2>Select a row in the table to view prescription and order medicine.</h2></center>
        ...
        <tr>
            ...
            <td  style="background-color: #ffffff"> 
                <table style="width:100%" id="table">
                    ...
                    <tr  >
                        <th style="text-align:center"><strong >PRESCRIPTION ID</strong></th>
                        <th style="text-align:center"><strong>DOCTOR ID</strong></th>
        ...
        for (var i = 1; i < table.rows.length; i++)
        {
            table.rows[i].onclick = function ()
            {
                //rIndex = this.rowIndex;
                    ...
                    var outString = "enter_details.jsp?pid=" + this.cells[0].innerHTML;
