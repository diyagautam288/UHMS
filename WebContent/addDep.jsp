        ...
        <div class="row">
            ...
            <div class="col-md-6">
                <div class="profile-head">
                    <h5 style="text-align: center">ADD DEPARTMENT</h5>
                </div><hr>
                <div style="margin-top:35px;">
                	<form method="post" action="succInDep.jsp">
							<center><h6>Department name:</h6></center><br>
							<center><input class="txtBox" type="text" name="Dept_name" autocomplete="off"></center>
							<br>
