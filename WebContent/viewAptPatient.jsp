<%-- 
    Document   : viewApt
    Created on : 8 Apr, 2021, 2:23:24 PM
    Author     : Shaiv
--%>
...
<html>
   ...
   int pid=user.getPid();
   ResultSet rs=st.executeQuery("select a.apt_num, a.apt_date, a.doc_id,a.fees, s.time from uhms.appointment a left join uhms.scheduler s on a.doc_id=s.doc_id where a.pid="+pid+"");
 %>    
