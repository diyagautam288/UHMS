   ...
   %>
    ...
    <nav class="navbar navbar-expand-lg">
      ...
      <!--BODY -->
        ...
        <%  
            session.setAttribute("type","UNPAID");
			...
			Statement stat = con.createStatement();
                        ...
                        r.next();
                        pname=r.getString(1);
                        rs= stat.executeQuery("SELECT * FROM MED_BILL WHERE PNAME='"+pname+"' AND STATUS='UNPAID' ORDER BY DATE DESC");
...
<!-- MENU BAR FOR PHARMACIST -->
 ...
 <!--BODY -->
        ...
        <%  
			...
			Statement stat = con.createStatement();
                        Statement stat2 = con.createStatement();
                        rs= stat.executeQuery("SELECT * FROM MED_BILL WHERE SHOP_NO="+shop_no+" AND STATUS='UNPAID' ORDER BY DATE DESC");
