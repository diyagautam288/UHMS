...
<body>
	...
	<div class="container emp-profile">
			<center><h2 style="margin-bottom:20px;">DOCTOR SCHEDULE VIEW</h2></center>
            <div class="tab">
			  <button class="tablinks" onclick="openOption(event, 'viewAll')">View All</button>
			  <button class="tablinks" onclick="openOption(event, 'viewID')">View By Doctor ID</button>
			</div>
        	...
        	con=DriverManager.getConnection("jdbc:oracle:thin:@localhost:1522:xe","XE","xe");
		                	...
		                	//Class.forName("oracle.jdbc.driver.OracleDriver");
					  //      Connection con=DriverManager.getConnection("jdbc:oracle:thin:@localhost:1522:xe","XE","xe");
					        PreparedStatement stmt=con.prepareStatement("select * from SCHEDULER WHERE DOC_ID=?");  
					        stmt.setString(1,ID );
