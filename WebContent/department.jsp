        ...
        <div class="row">
            ...
            <div class="col-md-6">
                <div class="profile-head">
                    <h5 style="text-align: center">Manage Department</h5>
                </div><hr>
                <div style="margin-top:35px;">
                	<center><button class="empMbutton" onclick="window.location.href='addDep.jsp';">ADD DEPARTMENT</button></center>
	                <center><button class="empMbutton" onclick="window.location.href='viewDep.jsp';">VIEW DEPARTMENT</button></center>
	                <center><button class="empMbutton" onclick="window.location.href='updateDep.jsp';">DELETE DEPARTMENT</button></center>
                </div>
            </div>
        </div>
    </div>
