     ...
     <center>
         <div >
             <table style="width: 50%" >
                 <tr >
                     <td style="font-size: x-large; text-align: right" >View all</td>
                     <td ><input type="radio" style="height: 25px;
  width: 25px;position: relative;" name="answer" value="all" /></td>
                     <td style="font-size: x-large;text-align: right">Search by name</td>
                     <td ><input style="height: 25px;
  width: 25px;position: relative;" type="radio" name="answer" value="search" /> </td>
                 </tr>
