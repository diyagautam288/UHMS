        ...
        <div class="row">
            ...
            <div class="col-md-6">
                <div class="profile-head">
                    <h5 style="text-align: center">VIEW PATIENT RECORD</h5>
                </div><hr>
                <div style="margin-top:35px;">
                	<center><button class="empMbutton" onclick="window.location.href='viewDocId.jsp';">VIEW BY DOCTOR ID</button></center>
	                <center><button class="empMbutton" onclick="window.location.href='viewDate.jsp';">VIEW BY DATE</button></center>
	                </div>
            </div>
        </div>
    </div>
