        ...
        <div class="row">
            ...
            <div class="col-md-6">
                <div class="profile-head">
                    <h5 style="text-align: center">Manage Doctor</h5>
                </div><hr>
                <div style="margin-top:35px;">
                	<center><button class="empMbutton" onclick="window.location.href='addDoc.jsp';">ADD DOCTOR</button></center>
	                <center><button class="empMbutton" onclick="window.location.href='viewDoc.jsp';">VIEW DOCTOR</button></center>
	                <center><button class="empMbutton" onclick="window.location.href='updateDoc.jsp';">UPDATE DOCTOR</button></center>
                	<center><button class="empMbutton" onclick="window.location.href='deleteDoc.jsp';">DELETE DOCTOR</button></center>
                </div>
            </div>
        </div>
    </div>
