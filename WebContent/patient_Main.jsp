<%-- 
    ...
    Created on : 12 Mar, 2021, 4:52:09 PM
    Author     : user
--%>
        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav ml-auto">
                    <li class="nav-item">
                        <a href="patient_Main.jsp" class="nav-link smoothScroll">Home</a>
                    </li>
                    <li class="nav-item">
                    ...
                    <li class="nav-item">
                        <a href="#" class="nav-link smoothScroll">Profile</a>
                    </li>
                </ul>
            </div>
        </div>
        ...
        <div class="row">
            ...
            <div class="col-md-6">
                <div class="profile-head">
                    <h5 style="text-align: center">Patient</h5>
                </div><hr>
                <div>
                    <p>
                        <strong style="color: black">Dashboard:</strong> In this section, patient can manage profile and order medicine.
                    </p><br>
                    <p>
                        <strong style="color: black">Order Medicine: </strong>In this section, patient can order medicines.
                    </p><br>
