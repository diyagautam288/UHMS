        ...
        <div class="row">
            ...
            <div class="col-md-6">
                ...
                <div style="margin-top:35px;">
                	<center><button class="empMbutton" onclick="window.location.href='viewAllP.jsp';">VIEW ALL</button></center>
	                <center><button class="empMbutton" onclick="window.location.href='viewIDP.jsp';">VIEW BY ID</button></center>
	                </div>
            </div>
        </div>
    </div>
