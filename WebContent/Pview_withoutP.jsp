    ...
    <body>
        ...
        <%
            ...
            try {
                ...
                ResultSet rs = stat.executeQuery("select without_presc.MED_ID, without_presc.QTY, med_order.ADDRESS, med_order.SHOP_NO from without_presc,med_order where med_order.ORDER_ID=" + oid + " and without_presc.ORDER_ID=" + oid);
