        ...
        <div class="row">
            ...
            <div class="col-md-6">
                <div class="profile-head">
                    <h5 style="text-align: center">Manage Doctor Schedule</h5>
                </div><hr>
                <div style="margin-top:35px;">
                	<center><button class="empMbutton" onclick="window.location.href='addSch.jsp';">ADD SCHEDULE</button></center>
	                <center><button class="empMbutton" onclick="window.location.href='viewSch.jsp';">VIEW SCHEDULE</button></center>
	                <center><button class="empMbutton" onclick="window.location.href='updateSch.jsp';">UPDATE SCHEDULE</button></center>
                </div>
            </div>
        </div>
    </div>
