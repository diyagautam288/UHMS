...
<html>
    ...
    <div class="container emp-profile">
        <center><h2 style="margin-bottom:20px;">PHARMACIST VIEW</h2></center>
        <div class="tab">
            <button class="tablinks" onclick="openOption(event, 'viewAll')">View All</button>
            <button class="tablinks" onclick="openOption(event, 'viewID')">View By EMAIL</button>
        </div>
        <div id="viewAll" class="tabcontent" style="overflow-x:auto;overflow-y:auto">
            <%
                try {
                    ...
                    ResultSet rs = st.executeQuery("select REG_USER.EMAIL,REG_USER.PASSWORD,REG_USER.F_NAME,REG_USER.L_NAME,REG_USER.GENDER,REG_USER.PHONE_NO,REG_USER.USER_TYPE,REG_USER.SECRET,PHARMACIST.SHOP_NO from PHARMACIST INNER JOIN REG_USER ON PHARMACIST.EMAIL=REG_USER.EMAIL");
                    String email = "";
        ...
        <div id="viewID" class="tabcontent" style="overflow-x:auto;overflow-y:auto">
                ...
                <center>
                    <div style="width:20%;margin-bottom:3%;margin-top:2%;">
                        <div class="wrap-input100 validate-input m-t-85 m-b-35">
                            ...
                            <span class="focus-input100" data-placeholder="PHARMACIST EMAIL"></span>
                        </div>
                ...
                <table border="1" class="table" >
                    ...
                    <%
                        try {
                            ...
                            //Class.forName("oracle.jdbc.driver.OracleDriver");
                            //        Connection con=DriverManager.getConnection("jdbc:oracle:thin:@localhost:1522:xe","XE","xe");
                            PreparedStatement stmt = con.prepareStatement("select REG_USER.EMAIL,REG_USER.PASSWORD,REG_USER.F_NAME,REG_USER.L_NAME,REG_USER.GENDER,REG_USER.PHONE_NO,REG_USER.USER_TYPE,REG_USER.SECRET,PHARMACIST.SHOP_NO from PHARMACIST INNER JOIN REG_USER ON PHARMACIST.EMAIL=REG_USER.EMAIL and REG_USER.EMAIL= ?");
