...
<html>
    ...
    <div class="container emp-profile">
        <center><h2 style="margin-bottom:20px;">UPDATE DOCTOR SCHEDULE</h2></center>
        <div>
            <%
            ...
            <%
                try {
                    ...
                    String sql = "select DOC_ID,WEEKDAY,TIME from SCHEDULER where DOC_ID= ?";
                    ps = con.prepareStatement(sql);
                    ps.setString(1, id);
                    resultSet = ps.executeQuery();
                    while (resultSet.next()) {
            %>
            <form method="POST" action="updateSch3.jsp">												
                <h3>DOC_ID: <input readonly name="id" value="<%=resultSet.getString("DOC_ID")%>"></h3>						
                <br>
                <div class="row">
                    <div class="col-md-6">
                        <div class="row">
                            ...
                            <div class="col-md-4" style="margin-bottom:20px;">
                                <input class="Input" type="text" name="weekday" value="<%=resultSet.getString("WEEKDAY")%>">
                                <br></div>
                    ...
                    <div class="col-md-6">
                        <div class="row">
                            ...
                            <div class="col-md-6" style="margin-bottom:20px;">
                                <input class="Input" type="time" name="time" value="<%=resultSet.getString("TIME")%>">
                            </div>
                        </div>
                    </div>
                </div>
