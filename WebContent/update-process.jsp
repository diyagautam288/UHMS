...
<html>
    ...
    <div class="container emp-profile" >
        ...
        <%
            ...
            String ph_n = request.getParameter("phone_number");
            ...
            if (id != null) {
            	...
            	con=DriverManager.getConnection("jdbc:oracle:thin:@localhost:1522:xe","XE","xe");
                    ...
                    //Class.forName("oracle.jdbc.driver.OracleDriver");
                    //con=DriverManager.getConnection("jdbc:oracle:thin:@localhost:1522:xe","XE","xe");
                    String sql = "Update DOCTOR set FEES=?where DOC_ID=" + id;
            	...
            	con=DriverManager.getConnection("jdbc:oracle:thin:@localhost:1522:xe","XE","xe");
                        ...
                        //Class.forName("oracle.jdbc.driver.OracleDriver");
                        //con=DriverManager.getConnection("jdbc:oracle:thin:@localhost:1522:xe","XE","xe");
                        String sql = "Update REG_USER set PHONE_NO=?,SECRET=? where EMAIL=(select EMAIL from DOCTOR where DOC_ID=" + id + ")";
                        ps = con.prepareStatement(sql);
                        ps.setString(1, ph_n);
