    ...
    <div class="container emp-profile">
        ...
        <%
            ...
            try {
                ...
                PreparedStatement stmt = con.prepareStatement("delete from SCHEDULER WHERE DOC_ID=?");
                stmt.setString(1,id);
                out.print(id);
                out.print(email);
                int k = stmt.executeUpdate();
                out.print(k);
                stmt = con.prepareStatement("delete from DOCTOR WHERE DOC_ID=?");
                stmt.setString(1, id);
                int i = stmt.executeUpdate();
                stmt = con.prepareStatement("delete from REG_USER WHERE EMAIL=?");
        ...
        %>
        <h1 style="text-align: center">SUCCESSFULLY DELETED!!</h1>
