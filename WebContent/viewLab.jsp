...
<html>
    ...
    <div class="container emp-profile">
        <center><h2 style="margin-bottom:20px;">LAB SPECIALIST VIEW</h2></center>
        <div class="tab">
        ...
        <div id="viewAll" class="tabcontent" style="overflow-x:auto;overflow-y:auto">
            <%
                try {
                    ...
                    PreparedStatement stmt = con.prepareStatement("select EMAIL,PASSWORD,F_NAME,L_NAME,GENDER,PHONE_NO,USER_TYPE,SECRET from REG_USER where USER_TYPE=?");
                    stmt.setString(1, ur);
                ...
                <center>
                    <div style="width:20%;margin-bottom:3%;margin-top:2%;">
                        <div class="wrap-input100 validate-input m-t-85 m-b-35">
                            ...
                            <span class="focus-input100" data-placeholder="LAB SPECIALIST EMAIL"></span>
                        </div>
                ...
                <table border="1" class="table" >
                    ...
                    <%
                        try {
                            ...
                            PreparedStatement stmt = con.prepareStatement("select EMAIL,PASSWORD,F_NAME,L_NAME,GENDER,PHONE_NO,USER_TYPE,SECRET from REG_USER where USER_TYPE=? AND EMAIL=?");
                            stmt.setString(1, ur);
