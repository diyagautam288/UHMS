                    ...
                    <li class="nav-item">
                        <div class="login">
                            ...
                            <div class="login-content">
                              ...
                              <a href="lab_Login.jsp">As Lab Incharge</a>
                            </div>
                        </div>
                    </li>
                    <li class="nav-item">
     ...
     <div class="limiter">
		<div class="container-login100">
			<div class="wrap-login100 p-t-85 p-b-20">
				<form class="login100-form validate-form" name="login" action="LoginCheck.jsp" method="post">
					...
					<div class="wrap-input100 validate-input m-t-85 m-b-35" data-validate = "Enter username">
						<input class="input100" type="email" autocomplete="off" name="username" required>
						<span class="focus-input100" data-placeholder="Username"></span>
					</div>

					<div class="wrap-input100 validate-input m-b-50" data-validate="Enter password">
						<input class="input100" type="password" id="myInput" name="pass" required>
					...
					<div class="container-login100-form-btn" style="margin-top: 4em">
						<button class="login100-form-btn" onclick="pharLoginCheck.jsp" value="Login">
							Login
						</button>
					</div>
