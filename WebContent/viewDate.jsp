...
<body>
	...
	<div class="container emp-profile">
			<center><h2 style="margin-bottom:20px;">VIEW APPOINTMENT</h2></center>    
			  ...
			  <form method="post" action="">
			  	...
			  	<div style="width:20%;margin-bottom:3%;margin-top:2%;">
			  		<div class="wrap-input100 validate-input m-t-85 m-b-35">
			  			<label>DATE</label>
						<input class="input100" type="date"  data-date-format="YYYY MMMM DD" autocomplete="off" name="Date">
        	...
        	con=DriverManager.getConnection("jdbc:oracle:thin:@localhost:1522:xe","XE","xe");
			        ...
			        PreparedStatement stmt=con.prepareStatement("select * FROM APPOINTMENT WHERE APT_DATE=?");
