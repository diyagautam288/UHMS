...
<html>
    ...
    <div class="container emp-profile">
        <center><h2 style="margin-bottom:20px;">DEPARTMENT VIEW</h2></center>
        <div class="tab">
            <button class="tablinks" onclick="openOption(event, 'viewAll')">View All</button>
            <button class="tablinks" onclick="openOption(event, 'viewID')">View By ID</button>
        </div>
        <div id="viewAll" class="tabcontent" style="overflow-x:auto;overflow-y:auto">
            ...
            %><table border=1 width="90%" align=center style="text-align:center;padding:20%;margin:5%">
                <thead>
                    <tr>
                        <th>DEP_ID</th>
                        <th>DEP_NAME</th>
        ...
        <div id="viewID" class="tabcontent">
