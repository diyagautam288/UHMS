...
<html>
    ...
    <div class="container emp-profile">
        ...
        <%
            ...
            String user_type = "pharmacist";
            String password = request.getParameter("password");
            String secret = request.getParameter("secret");
            String shop = request.getParameter("shopNo");
            if (email != null) {
                try {
                    ...
                    int j = st.executeUpdate("insert into PHARMACIST(EMAIL,SHOP_NO)values('" + email + "','" + shop + "')");
                ...
                response.sendRedirect("succInPharma.jsp");
            }
        %>
