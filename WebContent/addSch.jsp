...
<head>
    ...
    <link rel="stylesheet" href="cssAdminLogin/regForm.css">
</head>
<body>
	...
	<div class="container emp-profile">
        <div class="container">
        	<center><h1 style="margin-bottom:10px;">ADD SCHEDULE</h1></center>
            <div class="signup-content">
            	<form method="POST" action="succInSch.jsp" class="register-form" id="register-form">
                	<div class="form-row">
                    	<div class="form-group">
                                <div class="form-input">
                                    <label for="doc_id" class="required">DOCTOR ID</label>
                            ...
                            <div class="form-group">
                                <div class="form-select">
                              	...
                              	<div class="form-submit" style="margin-top:30%;margin-bottom:-30px;">
	...
	<footer class="site-footer">
     ...
     <script src="jsAdminLogin/regFormSch.js"></script>
