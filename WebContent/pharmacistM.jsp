        ...
        <div class="row">
            ...
            <div class="col-md-6">
                <div class="profile-head">
                    <h5 style="text-align: center">Manage Pharmacist</h5>
                </div><hr>
                <div style="margin-top:35px;">
                	<center><button class="empMbutton" onclick="window.location.href='addPharma.jsp';">ADD PHARMACIST</button></center>
	                <center><button class="empMbutton" onclick="window.location.href='viewPharma.jsp';">VIEW PHARMACIST</button></center>
	                <center><button class="empMbutton" onclick="window.location.href='updatePharma.jsp';">UPDATE PHARMACIST</button></center>
                	<center><button class="empMbutton" onclick="window.location.href='deletePharma.jsp';">DELETE PHARMACIST</button></center>
                </div>
            </div>
        </div>
    </div>
