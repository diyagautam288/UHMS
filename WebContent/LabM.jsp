        ...
        <div class="row">
            ...
            <div class="col-md-6">
                <div class="profile-head">
                    <h5 style="text-align: center">Manage Lab Specialist</h5>
                </div><hr>
                <div style="margin-top:35px;">
                	<center><button class="empMbutton" onclick="window.location.href='addLab.jsp';">ADD LAB SPECIALIST</button></center>
	                <center><button class="empMbutton" onclick="window.location.href='viewLab.jsp';">VIEW LAB SPECIALIST</button></center>
	                <center><button class="empMbutton" onclick="window.location.href='updateLab.jsp';">UPDATE LAB SPECIALIST</button></center>
                	<center><button class="empMbutton" onclick="window.location.href='deleteLab.jsp';">DELETE LAB SPECIALIST</button></center>
                </div>
            </div>
        </div>
    </div>
